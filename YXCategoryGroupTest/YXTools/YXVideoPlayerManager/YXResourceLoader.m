...
@interface YXResourceLoader ()

@property (nonatomic, strong) NSMutableArray * requestList;
@property (nonatomic, strong) YXRequestTask * requestTask;

@end

@implementation YXResourceLoader
...
- (void)newTaskWithLoadingRequest:(AVAssetResourceLoadingRequest *)loadingRequest cache:(BOOL)cache {
    ...
    self.requestTask = [[YXRequestTask alloc] init];
...
- (BOOL)finishLoadingWithLoadingRequest:(AVAssetResourceLoadingRequest *)loadingRequest {
    ...
    [loadingRequest.dataRequest respondWithData:[YXFileHandle readTempFileDataWithOffset:requestedOffset - self.requestTask.requestOffset length:respondLength]];
