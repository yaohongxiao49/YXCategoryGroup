...
- (void)updateWillShowAttibutes:(UICollectionView *)collection section:(NSInteger)section layoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes contentOffset:(CGPoint)contentOffset {
    ...
    NSIndexPath *firstObjectIndexPath = [NSIndexPath indexPathForRow:0 inSection:section];
    NSIndexPath *lastObjectIndexPath = [NSIndexPath indexPathForRow:MAX(0, (numberOfItemsInSection - 1)) inSection:section];
