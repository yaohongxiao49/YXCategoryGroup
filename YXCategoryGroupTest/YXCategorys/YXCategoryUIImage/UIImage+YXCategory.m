...
#pragma mark - 拼接图片
+ (void)joiningImgByArr:(NSMutableArray *)arr contextSize:(CGSize)contextSize sonWidth:(CGFloat)sonWidth sonHeight:(CGFloat)sonHeight spacing:(CGFloat)spacing direction:(YXJoiningImgDirectionType)direction endImgBlock:(void(^)(UIImage *endImg))endImgBlock {
    ...
    dispatch_group_notify(group, dispatch_get_main_queue(), ^{
        ...
        UIImage *endImg;
        if (direction == YXJoiningImgDirectionHorizontalType) {
